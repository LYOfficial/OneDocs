...
export const MODEL_PROVIDERS: ModelProviders = {
  onedocs: {
    ...
    models: [
      ...
      { value: 'Qwen/Qwen3-8B', name: 'Qwen3-8B', tags: [{ label: 'Fast', variant: 'fast' }] },
      { value: 'THUDM/glm-4-9b-chat', name: 'GLM-4-9B Chat' },
      { value: 'THUDM/GLM-Z1-9B-0414', name: 'GLM-Z1-9B 0414', tags: [{ label: 'Thinking' }] },
      {
      ...
      { value: 'glm-4-flash', name: 'GLM-4-Flash', tags: [{ label: 'Fast', variant: 'fast' }] },
    ],

...
export const MODEL_PROVIDERS: ModelProviders = {
  onedocs: {
    ...
    models: [
      ...
      { value: 'THUDM/GLM-Z1-9B-0414', name: 'GLM-Z1-9B 0414', tag: 'Thinking' },
      { value: 'THUDM/GLM-4.1V-9B-Thinking', name: 'GLM-4.1V-9B Thinking', tag: 'Thinking' },
      { value: 'THUDM/GLM-4-9B-0414', name: 'GLM-4-9B 0414' },
      { value: 'deepseek-ai/DeepSeek-R1-0528-Qwen3-8B', name: 'DeepSeek-R1 Qwen3-8B', tag: 'Thinking' },

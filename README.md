...
目前软件支持**Word、PPT、Excel、TXT、PDF**这些主流文档格式，支持**40+模型**选择，支持**Windows/macOS/Linux跨平台**使用，基本满足各类用户使用需求。且软件为本地下载使用，无文件上传，不会造成文件和API Key泄露。
...
- 最大文件体积：50 MB（FILE_SIZE_LIMIT）
- 解析位于 utils/documentProcessor.ts（基于 pdfjs、mammoth、jszip、exceljs）
